                ...
                <div class="col-md-12">
                    ...
                    <div class="page-title">
                        ...
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            ...
                            <?php } ?>
                            <h2>Capitulo <?php echo $row['Capitulo'] ?></h2>
                            ...
                            <form method="POST" action="actualizar1.php">
                                    <span> Actualizar Información de Capitulo</span>
                                    <br>
                                    <br>
                                    <h4 style="color: white">Cambiar Nombre de Capitulo</h4>
                                    <br>
                                <input placeholder="Cambiar Nombre" value="<?php echo $row['Nombre'] ?>"  name="nombre" required="" class="form-control" type="text">
                                <br>
                                    <h4 style="color: white">Cambiar Introducción del Capitulo</h4>
                                    <br>
                                <textarea name="Introduccion" rows="10" cols="46" placeholder="Introducción al Capitulo" required style="color: black"> <?php echo $row['Introduccion'] ?></textarea>
                                <br>
                                <br>
                                <button value=<?php echo $row['id'] ?> name='id' type="submit" name="submit" style="color: black"> Actualizar Información</button>
            ...
            <div class="row">
                    <?php
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            ...
                            foreach ($enlace->query("SELECT * from temas where capitulos_id ='$id' ") as $row){  ?>

                            
                          
                <div class="col-sm-6 col-md-3">
                    <!-- Single Member -->
                    <form action="curso5.php" method="post">
                    <div class="team-member">
                        <div class="member-top">
                            ...
                            <div class="team-social">
                                ...
                                <button value=<?php echo $row['idTema'] ?> name='id' type="submit" name="submit"> Actualizar Información del Tema</button>
                            </div>
                        </div>
                        <div class="member-dec">
                            <h4>Tema<?php echo $row['Tema'] ?></h4>
