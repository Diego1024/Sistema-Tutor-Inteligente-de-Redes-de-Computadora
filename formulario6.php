                        ...
                        <form action="insertar3.php" method="post" enctype="multipart/form-data" >
                            <div class="col-sm-6" align="center">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nombre" placeholder="Nombre del Subtema" required>
                                </div>

                                <div class="form-group">
                                <textarea name="Introduccion" rows="10" cols="46" placeholder="Pequeña Introducción al Subtema" required></textarea>
                                </div>

                                    <p style="color: white">.</p>

                                <div class="form-group">
                                <textarea name="Introduccion2" rows="10" cols="46" placeholder="Contenido del Subtema" required></textarea>
                                </div>
