                        ...
                        <form action="insertar1.php" method="post">
                            <div class="col-sm-6" align="center">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nombre" placeholder="Nombre del Capitulo" required>
                                </div>

                                <div class="form-group">
                                <textarea name="Introduccion" rows="10" cols="46" placeholder="Introducción al Capitulo" required></textarea>
                                </div>
                                    <p style="color: white">.</p>

                                <div class="form-group">
                                <input class="form-control" type="number" name="num" placeholder="Número de Temas" maxlength="2" required>
                                </div>

                                

                                <button align= type="submit" value= <?php echo $row['id'] ?> name ="id" class="sub-btn donate-btn more-btn hvr-shutter-out-horizontal">Continuar</button>
                            </div>
                        </form>
                    </div>
                </div>
