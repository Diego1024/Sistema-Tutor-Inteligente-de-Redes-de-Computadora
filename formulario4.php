                        ...
                        <form action="insertar2.php" method="post">
                            <div class="col-sm-6" align="center">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nombre" placeholder="Nombre del Tema" required>
                                </div>
                                ...
                                <div class="form-group">
                                <input class="form-control" type="number" name="num" placeholder="Número de Sub-Temas" maxlength="2" required>
                                </div>

                                

                                <button align= type="submit" value= <?php echo $row['idTema'] ?> name ="id" class="sub-btn donate-btn more-btn hvr-shutter-out-horizontal">Continuar</button>
                            </div>
                        </form>
                    </div>
                </div>
