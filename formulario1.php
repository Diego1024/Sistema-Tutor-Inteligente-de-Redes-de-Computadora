                ...
                <div class="col-md-12">
                    ...
                    <div class="page-title">
                        ...
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            ...
                            foreach ($enlace->query("SELECT * from capitulos where id = 2") as $row){  ?>
            ...
            <div class="row">
                    <?php
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            ...
                            foreach ($enlace->query("SELECT * from capitulos where Modulo = 'Fundamentos de Redes'") as $row){  ?>
                    ...
                    <div class="team-member">
                        <div class="member-top">
                            ...
                            <div class="team-social">
                                ...
                                <button value=<?php echo $row['id'] ?> name='id' type="submit" name="submit"> Ingresar Información de Capitulo</button>
                            </div>
                        </div>
