                    ...
                    <div class="col-md-10">
                        ...
                        <nav class="main-menu">
                            <ul class="navigation">
                                ...
                                <li><a href="#" class="menu-active">events<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                    <ul class="drop-menu">
                                        <li><a href="events-3col.html" class="menu-active">events 3col</a></li>
                        ...
                        <div class="donate-box">
                            <a href="#" class="donate-btn hvr-shutter-out-horizontal">donate</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="page-title">
                        ...
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            ...
                            <?php } ?>
                            <h2>Tema <?php echo $row['temas_idTema']?></h2>
                        </div>
                        <ul class="breadcrumb">
                            <?php 
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="single-events events-info">
                        ...
                        $consulta = "SELECT  folder,src FROM imagen  where  idSubtema = $id1";
                        ...
                        ?>
                            ...
                            <div class="post-date-info events-date">
                                <h4 style="color:white">Subtema</h4> <?php echo $row['Subtema'] ?>
                            </div>
                        </div>
                        <div class="news-content">
                            
                            <h2><?php echo $row['Nombre'] ?></h2>
                            <button value=<?php echo $row['idSubtema'] ?> name='id' type="submit" name="submit" class="sub-btn donate-btn more-btn hvr-shutter-out-horizontal">Ver Información </button>
                        </div>
                        </form>
                    </div>
                </div>
