                        ...
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            if (!$enlace) {
                                 die('No hay conexión con la base de datos' . mysqli_error());
                                                            ...
                                                            $consulta = "SELECT MAX(temas_idTema) as pre_has FROM subtema";  
                    ...
                    <div class="team-member">
                        <div class="member-top">
                            ...
                            <div class="team-social">
                                ...
                                <button value=<?php echo $row['idSubtema'] ?> name='id' type="submit" name="submit"> Ingresar Información del Subtema</button>
                            </div>
                        </div>
