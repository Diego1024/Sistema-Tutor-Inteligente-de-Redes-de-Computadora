                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <?php
                                        ...
                                        $consulta = "SELECT  folder,src FROM imagen  where  idSubtema = $id1 and id_foto=2";
                                        $sql = mysqli_query($enlace, $consulta) or trigger_error("error de consulta");
                                        $f=mysqli_fetch_array($sql);
                                        echo'<img src="'.$f['src'].'"/>';
                                        ?>
                                ...
                                <div class="item">
                                        ...
                                        $consulta = "SELECT  folder,src FROM imagen  where  idSubtema = $id1 and id_foto=3";
                                        $sql = mysqli_query($enlace, $consulta) or trigger_error("error de consulta");
                                        $f=mysqli_fetch_array($sql);
                                        echo'<img src="'.$f['src'].'"/>';
                                        ?>
                                ...
                                <div class="item">
                                        ...
                                        $consulta = "SELECT  folder,src FROM imagen  where  idSubtema = $id1 and id_foto=4";
                                        $sql = mysqli_query($enlace, $consulta) or trigger_error("error de consulta");
                                        $f=mysqli_fetch_array($sql);
                                        echo'<img src="'.$f['src'].'"/>';
                                        ?>
                                ...
                                <div class="item">
                                        ...
                                        $consulta = "SELECT  folder,src FROM imagen  where  idSubtema = $id1 and id_foto=5";
                                        $sql = mysqli_query($enlace, $consulta) or trigger_error("error de consulta");
                                        $f=mysqli_fetch_array($sql);
                                        echo'<img src="'.$f['src'].'"/>';
                                        ?>
                                ...
                                <div class="item">
                                        ...
                                        $consulta = "SELECT  folder,src FROM imagen  where  idSubtema = $id1 and id_foto=6";
                                        $sql = mysqli_query($enlace, $consulta) or trigger_error("error de consulta");
                                        $f=mysqli_fetch_array($sql);
                                        echo'<img src="'.$f['src'].'"/>';
                                        ?>
