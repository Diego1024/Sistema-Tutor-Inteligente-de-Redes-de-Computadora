                        ...
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            if (!$enlace) {
                                 die('No hay conexión con la base de datos' . mysqli_error());
                                       ...
                                       $id=$_POST['id'];
                                        foreach ($enlace->query("SELECT * from capitulos where id = '$id'") as $row1){  
            ...
            <div class="row">
                <div class="col-md-4 col-sm-5">
                    <div class="volunteers-img">
                        <?php 
                        $Tema=$row['Tema'];
                        $Cap=$row['capitulos_id'];
                        $consulta = "SELECT * FROM arbol WHERE Matricula ='$matricula' and Tema ='$Tema' and Capitulo= '$Cap' and Modulo = '$Mod' and Status ='Paso' ";  
                ...
                <img src="img/redes1.jpg" alt="">
                    </div>
                </div>
                

                <form method="post" action="subtemas.php">
                ...
                <div class="col-md-8 col-sm-7">
                    <div class="volunteers-info">
                        ...
                        <button value=<?php echo $row['idTema'] ?> name='id1' type="submit" name="submit" class="sub-btn donate-btn more-btn hvr-shutter-out-horizontal"> Ver Subtemas </button>
