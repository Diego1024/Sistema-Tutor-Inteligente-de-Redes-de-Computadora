                    ...
                    <div class="page-title">
                        ...
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            ...
                            <form method="POST" action="actualizar.php">
                                    <span> Actualizar Información de Unidad</span>
                                    <br>
                                    <br>
                                    <h4 style="color: white">Cambiar Nombre de Unidad</h4>
                                    <br>
                                <input placeholder="Cambiar Nombre" value="<?php echo $row['Modulo'] ?>"  name="nombre" required="" class="form-control" type="text">
                                <button value=<?php echo $row['Modulo'] ?> name='Modulo' type="submit" name="submit" style="color: black"> Actualizar nombre</button>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <!-- Single Member -->
                    <form action="curso4.php" method="post">
                    <div class="team-member">
                        <div class="member-top">
                            ...
                            <div class="team-social">
                                ...
                                <button value=<?php echo $row['id'] ?> name='id' type="submit" > Actualizar Información del Capitulo</button>
                            </div>
                        </div>
