                        ...
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            if (!$enlace) {
                                 die('No hay conexión con la base de datos' . mysqli_error());
                                                            ...
                                                            $consulta = "SELECT MAX(capitulos_id) as pre_has FROM temas";  
                            ...
                            <h2>Capitulo <?php echo $row['capitulos_id'] ?></h2>
                            <?php } ?>
                            <ul class="breadcrumb">
                    ...
                    <div class="team-member">
                        <div class="member-top">
                            ...
                            <div class="team-social">
                                ...
                                <button value=<?php echo $row['idTema'] ?> name='id' type="submit" name="submit"> Ingresar Información del Tema</button>
                            </div>
                        </div>
                       ...
                       <?php
                        $enlace =  mysqli_connect('localhost', 'root', '','sti');
                            ...
                            $sql = "SELECT * FROM cuestionario WHERE capitulos_id = '$id'"; 
                                ...
                                <h4 style="color: white">Cuestionario del Capitulo <?php echo $row['capitulos_id'] ?> Fue agregado correctamente</h4>
                                  <?php   }else{ ?>
                                  <form method="post" action="cuestionario.php">
                                    <h4 style="color: white">Agregar Cuestionario del Capitulo <?php echo $row['capitulos_id'] ?></h4>
                                    <br>
                                    <button value=<?php echo $row['capitulos_id'] ?> name='id' type="submit" name="submit" class="sub-btn donate-btn more-btn hvr-shutter-out-horizontal" > Agregar Cuestionario</button>
                                    </form>
                               <?php } ?>
